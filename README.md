...
5. **Fornecedores** - Instituições privadas ou Organizações responsáveis pelo fornecimento dos recursos necesários para as cestas.

## 3. Tecnologias Utilizadas
O sistema **Cesta Solidária** tem como objetivo a implementção dos conceitos obtidos ao decorrer da disciplina de **Banco de Dados**, ministrada pelo professor Rafael Will, como componente curricular da graduação em Engenharia de Software da Universidade Federal do Cariri (UFCA). 
